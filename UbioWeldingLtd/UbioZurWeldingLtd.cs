...
namespace UbioWeldingLtd
{
	...
	public class UbioZurWeldingLtd : MonoBehaviour
	{
		...
		private void OnDraw()
		{
			if (_guiVisible)
			{
				//Debug.Log(string.Format("{0}| OnDraw START", Constants.logPrefix));
				//Set the GUI Skin
				...
				//Debug.Log(string.Format("{0}| OnDraw END", Constants.logPrefix));
			}
		} //private void OnDraw()
		...
		{
			//Debug.Log(string.Format("{0}| OnErrorDisplay START", Constants.logPrefix));
			...
			GUI.DragWindow();
			//Debug.Log(string.Format("{0}| OnErrorDisplay END", Constants.logPrefix));
		...
		{
			//Debug.Log(string.Format("{0}| OnWarningDisplay START", Constants.logPrefix));
			GUILayout.BeginVertical();
			GUILayout.BeginHorizontal();
			...
			GUI.DragWindow();
			//Debug.Log(string.Format("{0}| OnWarningDisplay END", Constants.logPrefix));
		} //private void OnErrorDisplay()
		...
		{
			//Debug.Log(string.Format("{0}| OnOverwriteDisplay START", Constants.logPrefix));
			...
			GUI.DragWindow();
			//Debug.Log(string.Format("{0}| OnOverwriteDisplay END", Constants.logPrefix));
		} //private void OnErrorDisplay()
		...
		{
			//Debug.Log(string.Format("{0}| OnSavedDisplay START", Constants.logPrefix));
			GUILayout.BeginVertical();
			GUILayout.BeginHorizontal();
			...
			GUI.DragWindow();
			//Debug.Log(string.Format("{0}| OnSavedDisplay END", Constants.logPrefix));
		} //private void OnErrorDisplay()
		...
		{
			//Debug.Log(string.Format("{0}| OnInfoWindow START", Constants.logPrefix));
			float margin = 2.5f;
			...
			GUI.DragWindow();
			//Debug.Log(string.Format("{0}| OnInfoWindow END", Constants.logPrefix));
		} //private void OnWarningDisplay(int windowID)
		...
		{
			//Debug.Log(string.Format("{0}| ReloadDatabase START", Constants.logPrefix));
			...
			//Debug.Log(string.Format("{0}| ReloadDatabase END", Constants.logPrefix));
		}
		...
		{
			//Debug.Log(string.Format("{0}| ClearEditor START", Constants.logPrefix));
			...
			//Debug.Log(string.Format("{0}| ClearEditor END", Constants.logPrefix));
		}
